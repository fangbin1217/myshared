...
$localConfig['menu'] = [
    ['id'=>1, 'name'=>'MYSQL'],['id'=>2, 'name'=>'PHP'],['id'=>3, 'name'=>'LINUX'],['id'=>4, 'name'=>'GIT'],
    ['id'=>5, 'name'=>'JS'],['id'=>6, 'name'=>'SWOOLE'],['id'=>7, 'name'=>'EGRET'],
];

$localConfig['MYSQL'] = [
    ['id'=>'1-1', 'name'=>'MYSQL数据库设计规范']
];
$localConfig['ARTICLE1-1'] =
    ['name'=>'MYSQL数据库设计规范', 'detail'=>'MYSQL数据库设计规范<br><br>
 
    &nbsp;&nbsp;&nbsp;&nbsp;1、数据库命名规范
        采用26个英文字母(区分大小写)和0-9的自然数(经常不需要)加上下划线\'_\'组成;
        命名简洁明确(长度不能超过30个字符);
        例如：user, stat, log, 也可以wifi_user, wifi_stat, wifi_log给数据库加个前缀;
        除非是备份数据库可以加0-9的自然数：user_db_20151210;<br><br>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;2、数据库表名命名规范
        ...
        表前缀\'user_\'可以有效的把相同关系的表显示在一起;<br><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;③非主键字段不能互相依赖。<br>
        ...
        备注：往往我们在设计表中不能遵守第三范式,因为合理的沉余字段将会给我们减少join的查询;
              例如：相册表中会添加图片的点击数字段,在相册图片表中也会添加图片的点击数字段;<br><br>
...
MYSQL数据库设计原则<br><br>
    ...
    1、核心原则
        ...
        平衡范式与冗余(效率优先；往往牺牲范式)
        拒绝3B(拒绝大sql语句：big sql、拒绝大事物：big transaction、拒绝大批量：big batch);<br><br>
 
    2、字段类原则
        用好数值类型(用合适的字段类型节约空间);
        字符转化为数字(能转化的最好转化,同样节约空间、提高查询性能);
        避免使用NULL字段(NULL字段很难查询优化、NULL字段的索引需要额外空间、NULL字段的复合索引无效);
        少用text类型(尽量使用varchar代替text字段);<br><br>
