...
<div id="page" class="hfeed site" style="background:url(<?php echo config('local')['imgHost'].'index/bg0301.png'; ?>) repeat;">
    ...
    <header id="masthead" class="site-header">
        <div id="header-main" class="header-main">
            <nav id="top-header">
                <div class="top-nav">
                    <div id="user-profile">
                        <div class="user-login">欢迎光临【花好月圆】！</div>
                        <div class="nav-set">
                            <div class="nav-login">
                                <?php if ($login) { ?>
                                    <a href="<?php echo config('local')['website'].'admin'; ?>" id="login-main">您好！<span><?php echo $login['uname']; ?></span></a>
                                <?php  } else {?>
                                    <a style="color:#576B95;" href="<?php echo config('local')['website'].'login'; ?>" id="login-main">登录</a>
                                <?php  }?>
                            </div>
                        </div>
                        <div class="clear"></div>
            ...
            <div id="menu-box">
                <div id="top-menu">
                    <div class="logo-site">
                        <h1 class="site-title">
                            <a href="<?php echo config('local')['website']; ?>"><img src="<?php echo config('local')['imgHost'].'index/logo0229.png'; ?>" title="花好月圆的个人经验" alt="花好月圆的个人经验" rel="home" /><span class="site-name">花好月圆的个人经验</span></a>
                        </h1>
                    </div>
    ...
    <!-- 这里是公告模块 -->
    <?php } else { ?>
        <div class="bull"><i class="be" style="font-weight:bold;color:#777;"><a href="<?php echo config('local')['website']; ?>"><img src="<?php echo config('local')['imgHost'].'index/home0229.png'; ?>"/></a>&nbsp;<?php echo $navName; ?></i></div>
    <?php } ?>
    </nav>
    <!-- 这里是公告模块 -->
    ...
    <ul id="scroll">
        ...
        <li style="padding:0 0 5px;"><a style="width:36px;height:36px;" class="scroll-h" title="返回顶部"><i class="be"><img src="<?php echo config('local')['imgHost'].'index/up16.png'; ?>" style="width:24px;height:16px;" /></i></a></li>
            ...
            <div class="qqonline-box" style="display: none;" id="qqonline-box">
                <div class="qqonline-main">
                    <div class="nline-wiexin">
                        <h4>微信</h4>
                        <img title="微信" alt="微信" src="<?php echo config('local')['imgHost'].'index/wx0229.png'; ?>">
                    </div>
    ...
    <!-- 这里是版权说明模块 -->
    <footer id="colophon" class="site-footer" role="contentinfo" style="position: relative;bottom:0;width:100%;">
        <div class="site-info">
            <strong>
                Copyright©2019-<?php echo date('Y');?>年fyy6.com花好月圆版权所有.<a href="http://www.beian.miit.gov.cn" style="color:#576B95;">浙ICP备17059682号-2</a>
            </strong> <span class="add-info">
        </div>
    </footer>
    <!-- 这里是版权说明模块 -->
</div>
