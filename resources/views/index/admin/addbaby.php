...
<div>
    <form method="post" action="<?php echo config('local')['website']; ?>/admin/savebaby" enctype="multipart/form-data">
        <div>
            <textarea name="title" class="content" placeholder="添加标题" rows="2"></textarea>
            <textarea name="mydate" class="content" placeholder="时间" rows="1"><?php echo date('Y-m-d');?></textarea>
            是否公开
